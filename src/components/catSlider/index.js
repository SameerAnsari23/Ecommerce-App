                    ...
                    <Slider {...settings} className='cat_slider_Main' id="cat_slider_Main" >
                        ...
                        <div className='item'>
                            <div className='info' style={{ background: '#fff3eb' }}>
                                <img src='https://wp.alithemes.com/html/nest/demo/assets/imgs/shop/cat-12.png' width="100"/>
                                <h5>Cake & Milk</h5>
                                <p>26 items</p>
                            </div>
                        </div>
                        ...
                        <div className='item'>
                            <div className='info' style={{ background: '#fff3ff' }}>
                                <img src='https://wp.alithemes.com/html/nest/demo/assets/imgs/shop/cat-11.png' width="100"/>
                                <h5>Cake & Milk</h5>
                                <p>26 items</p>
                            </div>
                        </div>
                        ...
                        <div className='item'>
                            <div className='info' style={{ background: '#f2fce4' }}>
                                <img src='https://wp.alithemes.com/html/nest/demo/assets/imgs/shop/cat-9.png' width="100"/>
                                <h5>Cake & Milk</h5>
                                <p>26 items</p>
                            </div>
                        </div>
