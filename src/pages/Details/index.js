                        ...
                        <div className='col-md-7 productInfo'>
                            ...
                            <div className='d-flex align-items-center'>
                                ...
                                <div className='d-flex align-items-center'>
                                    ...
                                    <Button className=' btn-lg addtocartbtn mr-3 btn-border'><FavoriteBorderOutlinedIcon /> </Button>
                                    <Button className=' btn-lg addtocartbtn mr-3 btn-border'><CompareArrowsIcon /></Button>
                                                        ...
                                                        <div className='card p-4 reviewsCard flex-row' key={index}>
                                                            ...
                                                            <div className='container'>
                                                                ...
                                                                <div className='info pl-5'>
                                                                    ...
                                                                    <p className='ml-3'>{item.review}</p> {/* Bootstrap utility class for margin-left */}
                                                                </div>
                                                            </div>
